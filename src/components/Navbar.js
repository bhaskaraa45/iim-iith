      ...
      <nav id={activeNavItem === "/" && !chalu && !clicked ? "navigation" : ""}>
        ...
        >
          ...
          <div className="desktop">
            <img
              src={activeNavItem === "/" && chalu ? iith_name_logo : iith_logo}
              height={48}
              className="iithLogo"
              alt="IIT Hyderabad Logo"
            />
            ...
            <img
              src={
                activeNavItem === "/" && chalu ? iim_name_logo : iim_logo_best
              }
              height={activeNavItem === "/" && chalu ? 50 : 42}
              className="iimLogo"
              alt="IIM Logo"
            />
          </div>
        ...
        <div>
          <ul
            id={activeNavItem === "/" && !chalu ? "notScrolled" : ""}
          ...
          >
            ...
            <li>
              <Link
                to="/gallery"
                className={activeNavItem === "/gallery" ? "active" : ""}
                onClick={() => handleNavItemClick("/gallery", "/gallery")}
              >
                Gallery
              </Link>
            </li>
            ...
            <li>
              <Link
                ...
                onClick={() => handleNavItemClick("/about", "/about")}
              >
                About
              </Link>
            </li>
        ...
        <div
          className={
            activeNavItem === "/" && !chalu ? "phone iconWhite" : "phone"
          }
          onClick={changeState}
        >
          <i id="bar">
